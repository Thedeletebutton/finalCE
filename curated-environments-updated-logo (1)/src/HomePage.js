    ...
    <main className="min-h-screen bg-white text-gray-900">
      <nav className="sticky top-0 z-50 bg-white border-b shadow-sm h-20 px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="/CURATED ENVIRONMENTS FINAL DRAFT BLUE2.png" alt="Logo" className="w-16 h-16" />
        </div>
      ...
      <section className="bg-black text-white py-8 px-6 text-center"><div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
