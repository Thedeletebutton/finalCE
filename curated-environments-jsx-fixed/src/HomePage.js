...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-black text-white py-10 px-6 text-center"><div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
      ...
      <section id="about" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="bg-gray-100 py-16 px-6 text-center"><div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 list-disc text-lg text-gray-800 text-left mx-auto w-fit pl-4">
