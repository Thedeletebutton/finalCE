...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-black text-white py-2 px-6 text-center"><div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <div className="flex flex-col items-center justify-center">
          <img src="/CURATED ENVIRONMENTS FINAL DRAFT BLUE2.png" alt="Curated Environments Logo" className="w-24 h-auto md:w-[300px] md:h-auto mb-4" />
